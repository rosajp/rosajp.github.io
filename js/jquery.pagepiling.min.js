...
!(function (e, n, t, o) {
	...
	e.fn.pagepiling = function (i) {
			...
			if (!o.activeSection.is(n)) {
				'undefined' == typeof o.animated && (o.animated = !0),
					...
					e.isFunction(Z.onLeave) &&
						Z.onLeave.call(this, o.leavingSection, o.sectionIndex + 1, o.yMovement),
					r(o),
					A(o.anchorLink),
		...
		function I(e) {
			...
			return (
				(n.y =
					'undefined' != typeof e.pageY && (e.pageY || e.pageX) ? e.pageY : e.touches[0].pageY),
				(n.x =
					'undefined' != typeof e.pageX && (e.pageY || e.pageX) ? e.pageX : e.touches[0].pageX),
				n
			);
		}
		function X(e) {
		...
		function q() {
			...
			for (var t = 0; t < e('.pp-section').length; t++) {
				...
				n.find('ul').append(
					'<li data-tooltip="' + i + '"><a href="#' + o + '"><span></span></a></li>'
				);
			}
		...
		e.extend(e.easing, {
			...
			(B.moveTo = function (t) {
				var o = '';
				(o = isNaN(t) ? e(n).find('[data-anchor="' + t + '"]') : e('.pp-section').eq(t - 1)),
					o.length > 0 && c(o);
			}),
